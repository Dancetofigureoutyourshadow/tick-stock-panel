...
export const QK = {
  ...
  portfolioSettings:     ['portfolio-settings'] as const,
  ...
  sectorRotation:       (kind: string, bucket?: number, seriesKey?: string, filterKey?: string) => ['sector-rotation', kind, bucket ?? 5, seriesKey ?? '', filterKey ?? ''] as const,
